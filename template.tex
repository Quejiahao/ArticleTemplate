...
\begin{figure}[H]
	\resizebox{0.9\linewidth}{!}{\input{figure.pgf}}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{minipage}[t]{.25\linewidth}\centering
\qrh{https://payapp.weixin.qq.com/qr/AQFDgsX2aC5OpT2_cg63D1ug?t=CwAK\#wechat_pay}
\end{minipage}
\begin{minipage}[t]{.25\linewidth}\centering
\qrh{HTTPS://QR.ALIPAY.COM/FKX079043IEA1AEHJFJM84}
\end{minipage}
\caption*{\heiti\zihao{3}付款码}
\end{figure}
